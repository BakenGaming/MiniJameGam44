...
public class PlayerInputController_Platformer : MonoBehaviour, IInputHandler
{
    ...
    private void HandleJumpInput(InputAction.CallbackContext context)
    {
        if(CanJump())
        {
            playerRB.linearVelocity = new Vector2(playerRB.linearVelocity.x, _playerStats.GetJumpPower());
    ...
    private void FixedUpdate() 
    {
        ...
        playerRB.linearVelocity = new Vector2(moveSpeed.x * _playerStats.GetMoveSpeed(), playerRB.linearVelocity.y);  
    }
